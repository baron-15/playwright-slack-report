...
export default class SlackClient {
    ...
    private static getTestDisplayName;
    private static makeFilename;
    private static buildFailureLogEntries;
    sendMessage({ options, }: {
        options: {
    ...
    sendFailureConsoleLogs({ channelIds, summaryResults, maxNumberOfFailures, threadTimestamp, }: {
        channelIds: Array<string>;
        summaryResults: SummaryResults;
        maxNumberOfFailures: number;
